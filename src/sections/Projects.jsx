  ...
  return (
    ...
    >
      <div className='max-w-[1240px] mx-auto xs:px-10 text-center'>
        <h1 className='text-white md:text-4xl xs:text-4xl tracking-wide font-bold'>My Projects</h1>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 rounded-lg bg-slate-800'>
          ...
          <p className='text-[14px] px-4 mb-5 italic text-sky-300'>ReactJS, TailwindCSS, FireBase</p>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 rounded-lg bg-slate-800'>
          ...
          <p className='text-[14px] px-4 mb-5 italic text-sky-300'>ReactJS, TailwindCSS, NodeJS, Framer-Motion, MySQL, theMealDB API </p>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 rounded-lg bg-slate-800'>
          ...
          <h2 className='text-2xl font-bold px-4 mt-5'>DCISM Inventory System</h2>
          <p className='text-[14px] px-4 mb-5 italic text-sky-300'>ReactJS, ChakraUI, NodeJS, MySQL</p>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 rounded-lg bg-slate-800'>
          ...
          <p className='text-[14px] px-4 mb-5 italic text-sky-300'>PHP, JavaScript, MySQL</p>
        ...
        <div className='w-full shadow-xl flex flex-col p-4 rounded-lg bg-slate-800'>
          ...
          <h2 className='text-2xl font-bold px-4 mt-5'>PAROKYANO <span className='text-gray-400 text-sm'>(Ongoing)</span></h2>
          <p className='text-[14px] px-4 mb-5 italic text-sky-300'>ReactJS, MaterialUI, NodeJS, Python, MySQL</p>
