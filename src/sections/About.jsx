    ...
    <div className="w-full h-screen py-24 px-4 mt-20 text-white md:text-justify xs:text-center">
      <div ref={ref} className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <motion.div
          ...
          <h1 className="md:text-5xl xs:text-3xl font-[Tahoma] md:tracking-wider font-bold py-4">
            Jolony Tim N. Tangpuz
          </h1>
          ...
          <div className="flex space-x-8 mb-8 md:ml-2 md:justify-start xs:justify-center">
            <a
              href="https://www.facebook.com/profile.php?id=100005535220914"
              className="text-white hover:text-gray-400">
              <FontAwesomeIcon icon={faFacebook} size="2x" />
            </a>
            <a
              href="https://www.instagram.com/jolotangpuz/"
              className="text-white hover:text-gray-400">
              <FontAwesomeIcon icon={faInstagram} size="2x" />
            </a>
            <a
              href="https://www.linkedin.com/in/jolony-tim-tangpuz-53b529214/"
              className="text-white hover:text-gray-400">
              <FontAwesomeIcon icon={faLinkedin} size="2x" />
            </a>
            <a
              href="https://github.com/b1gmcdaddy"
              className="text-white hover:text-gray-400">
          ...
          <span className="font-medium">
            <Link
              ...
              offset={-70}
              duration={300}
              className="border-solid mr-6 rounded-full py-3 px-5 bg-neutral-200 cursor-pointer hover:bg-neutral-100 text-black">
              Contact Me
              <FontAwesomeIcon icon={faContactBook} className="ml-2" />
            </Link>
            <a
              href="/JOLONY TIM N. TANGPUZ RESUME.pdf"
              download
              className="border-solid rounded-full py-3 px-5 bg-sky-700 hover:bg-sky-600">
              Download Resume
